...
//          "HISTOGRAMAnimationType": "bounce",  //linear,circle,elastic,bounce
      ...
      if(self.compareEvent == false){
        self.genome = self.argumentsBiocircosGenome[0];
        self.genome_matrix(self.argumentsBiocircosGenome[0]);
        self.genome2 = 0;
        self.genome_matrix2(0);
      }else{
        self.genome = self.argumentsBiocircosGenome[0];
        self.genome_matrix(self.argumentsBiocircosGenome[0]);
        self.genome2 = self.argumentsBiocircosGenome[1];
        self.genome_matrix2(self.argumentsBiocircosGenome[1]);
      }
  ...
  BioCircos.prototype.update_BUBBLEsettings = function(settings_object){
    var self = this;
    $.extend(self.BUBBLEsettings, settings_object);
  }
  
  BioCircos.prototype.update_GENEsettings = function(settings_object){
    var self = this;
  ...
  BioCircos.prototype.update_LABELsettings = function(settings_object){
    var self = this;
  ...
  BioCircos.prototype.update_CHORDsettings = function(settings_object){
    var self = this;
    $.extend(self.CHORDsettings, settings_object);
  }
  
//  BioCircos.prototype.update_COMPAREsettings = function(settings_object){
//    var self = this;
...
//  }
  ...
  BioCircos.prototype.update_WIGsettings = function(settings_object){
    var self = this;
  ...
  //legend
  BioCircos.prototype.update_LEGENDsettings = function(settings_object){
    var self = this;
    $.extend(self.LEGENDsettings, settings_object);
  }
  //legend

  BioCircos.prototype.update_AUXILIARYLINEsettings = function(settings_object){
    var self = this;
  ...
  //zhec3
  BioCircos.prototype.update_LOLLIPOPsettings = function(settings_object){
    var self = this;
  ...
  BioCircos.prototype.init_BUBBLEsettings = function(){
    var self = this;
    self.BUBBLEsettings = {
          "compareGroup":1,
          "minRadius": 100,
  ...
  BioCircos.prototype.init_GENEsettings = function(){
    var self = this;
    self.GENEsettings = {
          "compareGroup":1,
          "innerRadius": -30,
...
//          "GENEAnimationDirection":"S2E", //S2E,E2S  [start to end/end to start]
  ...
  BioCircos.prototype.init_LABELsettings = function(){
    var self = this;
    self.LABELsettings = {
          "compareGroup":1,
          "LABELSize": 10,
  ...
  BioCircos.prototype.init_CHORDsettings = function(){
    var self = this;
    self.CHORDsettings = {
        "CHORDinnerRadius": 108,
        "CHORDouterRadius": 110,
...
//  BioCircos.prototype.init_COMPAREsettings = function(){
//    var self = this;
//    self.COMPAREsettings = {
//        "COMPAREinnerRadius": 108,
//        "COMPAREouterRadius": 110,
...
//          "HISTOGRAMAnimationType": "bounce",  //linear,circle,elastic,bounce
  ...
  BioCircos.prototype.init_WIGsettings = function(){
    var self = this;
    self.WIGsettings = {
          "compareGroup":1,
          "maxRadius": 108,
  ...
  //legend
  BioCircos.prototype.init_LEGENDsettings = function(){
    var self = this;
    self.LEGENDsettings = {
          "x": 20,
          "y": 20,
  ...
  BioCircos.prototype.init_AUXILIARYLINEsettings = function(){
    var self = this;
    self.AUXILIARYLINEsettings = {
          "startX": 20,
          "startY": 20,
  ...
  //zhec3
  BioCircos.prototype.init_LOLLIPOPsettings = function(){
    var self = this;
    self.LOLLIPOPsettings = {
          "compareGroup":1,
          "LOLLIPOPFillColor": "red",
...
//      console.log(self.genomeLength)
  ...
  //compare
  BioCircos.prototype.genome_matrix2 = function(genome){
      var self = this;
      if(genome == 0){
        self.genomeLabel2 = 0;
  ...
  BioCircos.prototype.BUBBLE_value_maxmin = function(BUBBLEIn){
      var self = this;
  ...
  //zhec3
  BioCircos.prototype.LOLLIPOP_value_maxmin = function(LOLLIPOPIn){
      var self = this;
  ...
  //WIG
  BioCircos.prototype.WIG_value_maxmin = function(WIGIn){
      var self = this;
      var i=WIGIn.length;
  ...
  //SNPr2class
  BioCircos.prototype.snp_r2Value_color = function(r2Value){
      var self = this;
...
//            console.log("genesettings",self.GENEsettings)
            if(drawTime == self.GENEsettings.compareGroup){
                if(self.GENEsettings.compareGroup == 1){
                  var gene_objects = BioCircosGene(chord.groups())
                }else{
                  var gene_objects = BioCircosGene2(chord.groups())
                }
              ...
              //    svg.append("g")
              //        .attr("class", "BioCircosGENE")
              //        .selectAll("path.BioCircosGENE")
              //          .data(gene_objects)
              //          .enter()
              //        .append("path")
              //        .attr("class", "BioCircosGENE")
...
//
                              ...
                              var curve = svg.append("g")
                                        .attr("class", "BioCircosGENEarrow")
                                        .selectAll("path.BioCircosGENEarrow")
                                          .data(gene_objects)
                                          .enter()
                                        .append("path")
                                        .attr("fill","none")
                              ...
                              if(self.GENEsettings.GENEAnimationDisplay == true){
                                for (var i=0; i*arrowGap <= 100; i++) {
                                  ...
                                  var pathArrow1 = svg.append("g")
                                                      .attr("class", "BioCircosGENEar")
                                                      .selectAll("path.BioCircosGENEar")
                                                        .data(gene_objects)
                                                        .enter()
                                                      .append("text")
                                                      ...
                                                      .transition()
                                                      .delay(function(d,i){
                                                        return i * self.GENEsettings.GENEAnimationDelay;
                                                      })
...
//                                    console.log("i",i)
        ...
        if(self.settings.GENEMouseEvent==true){
            var GENEMouseOnTooltip = d3.select("body")
                .append("div")
                .attr("class","BioCircosGENETooltip")
                .attr("id","BioCircosGENETooltip")
                .style("opacity",0);

            var GENEMouseOn = svg.selectAll("path.BioCircosGENE");
            if(self.settings.GENEMouseOverDisplay==true){
                   GENEMouseOn.on("mouseover",function(d){
                       
                        if(self.ticksOffset !=undefined){
                          GENEMouseOnTooltip.html(self.settings.GENEMouseOverTooltipsHtml01+d.gene_chr+self.settings.GENEMouseOverTooltipsHtml02+(parseInt(d.gene_start)+self.ticksOffset)+self.settings.GENEMouseOverTooltipsHtml03+(parseInt(d.gene_end)+self.ticksOffset)+self.settings.GENEMouseOverTooltipsHtml04+d.gene_name+self.settings.GENEMouseOverTooltipsHtml05+d.gene_strand+self.settings.GENEMouseOverTooltipsHtml06+d.gene_type+self.settings.GENEMouseOverTooltipsHtml07)
                  ...
                  .style("stroke-width", function(d,i) { if(self.settings.GENEMouseOverArcStrokeWidth=="none"){return "";}else{return self.settings.GENEMouseOverArcStrokeWidth;} });
                          ...
                          GENEMouseOnTooltip.html(self.settings.GENEMouseOverTooltipsHtml01+d.gene_chr+self.settings.GENEMouseOverTooltipsHtml02+d.gene_start+self.settings.GENEMouseOverTooltipsHtml03+d.gene_end+self.settings.GENEMouseOverTooltipsHtml04+d.gene_name+self.settings.GENEMouseOverTooltipsHtml05+d.gene_strand+self.settings.GENEMouseOverTooltipsHtml06+d.gene_type+self.settings.GENEMouseOverTooltipsHtml07)
                  .style("left", (d3.event.pageX) + "px")
                  .style("top", (d3.event.pageY + 20) + "px")
                  .style("position", self.settings.GENEMouseOverTooltipsPosition)
                  .style("background-color", self.settings.GENEMouseOverTooltipsBackgroundColor)
    ...
    if(self.HISTOGRAM.length > 0){
            ...
            function BioCircosHISTOGRAM2(d) {
              return self.HISTOGRAM[histogrami].map(function(v, i) {
                var histogram_k = (d[self.initGenome[v.chr]].endAngle - d[self.initGenome[v.chr]].startAngle) / d[self.initGenome[v.chr]].value;
                return {
        ...
        for(var histogrami=0; histogrami<self.HISTOGRAM.length; histogrami++){
            ...
            if(drawTime == self.HISTOGRAMsettings.compareGroup){
               if(self.HISTOGRAMsettings.compareGroup == 1){
                  ...
                  var histogram_objects = BioCircosHISTOGRAM2(chord.groups())
                }
              ...
              if(self.HISTOGRAMsettings.HISTOGRAMAnimationDisplay == true){
                svg.append("g")
                    ...
                    .transition()
                    .delay(function (d,i) {
                      return i*self.HISTOGRAMsettings.HISTOGRAMAnimationDelay;
                    })
...
//                    .ease(self.HISTOGRAMsettings.HISTOGRAMAnimationType)
        ...
        if(self.settings.HISTOGRAMMouseEvent==true){
            ...
            if(self.settings.HISTOGRAMMouseOverDisplay==true){
                HISTOGRAMMouseOn.on("mouseover",function(d){
                      ...
                      if(self.ticksOffset != undefined){
                        HISTOGRAMMouseOnTooltip.html(self.settings.HISTOGRAMMouseOverTooltipsHtml01+d.histogram_chr+self.settings.HISTOGRAMMouseOverTooltipsHtml02+(parseInt(d.histogram_start)+self.ticksOffset)+self.settings.HISTOGRAMMouseOverTooltipsHtml03+(parseInt(d.histogram_end)+self.ticksOffset)+self.settings.HISTOGRAMMouseOverTooltipsHtml04+d.histogram_name+self.settings.HISTOGRAMMouseOverTooltipsHtml05+d.histogram_value+self.settings.HISTOGRAMMouseOverTooltipsHtml06)
        ...
        for(var linei=0; linei<self.LINE.length; linei++){
            ...
            if(drawTime == self.LINEsettings.compareGroup){
               if(self.LINEsettings.compareGroup == 1){
                  ...
                  var line_objects = BioCircosLINE2(chord.groups())
                }
  ...
  //                              return chri*2000;
                                if(self.LINEsettings.LINEAnimationDirection == "S2E"){
                                  return chri*self.LINEsettings.LINEAnimationDelay;
                                }
                                if(self.LINEsettings.LINEAnimationDirection == "E2S"){
                                  return (self.genomeLabel.length-1-chri)*self.LINEsettings.LINEAnimationDelay;
                                }
                              })
  //                            .duration(4000)
    ...
    if(self.WIG.length > 0){
        ...
        for(var WIGi=0; WIGi<self.WIG.length; WIGi++){
            ...
            if(drawTime == self.WIGsettings.compareGroup){
              if(self.WIGsettings.compareGroup == 1){
                var WIG_objects = BioCircosWIG(chord.groups())
              }else{
                var WIG_objects = BioCircosWIG2(chord.groups())
              }
                ...
                if(WIG_objects_a_chr.length != 0){
                  if(self.WIGsettings.WIGAnimationDisplay == true){
                    svg.append("g")
                                ...
                                .transition()
                                .delay(function (d,i) {
                                  return i*self.WIGsettings.WIGAnimationDelay;
                                })
        ...
        if(self.settings.WIGMouseEvent==true){
            var WIGMouseOnTooltip = d3.select("body")
                .append("div")
                .attr("class","BioCircosWIGTooltip")
                .attr("id","BioCircosWIGTooltip")
                .style("opacity",0);

            var WIGMouseOn = svg.selectAll("path.BioCircosWIG");

            if(self.settings.WIGMouseOverDisplay==true){
                WIGMouseOn.on("mouseover",function(d){
                      WIGMouseOnTooltip.html(self.settings.WIGMouseOverTooltipsHtml01)
                       .style("left", (d3.event.pageX) + "px")
                       .style("top", (d3.event.pageY + 20) + "px")
...
//            console.log(i)
      ...
      for(var legendi=0; legendi<self.LEGEND.length; legendi++){
        ...
        var legend_objects = BioCircosLEGEND(chord.groups())
//        console.log(legend_objects)
          for(var objecti=0; objecti<legend_objects.length;objecti++){
              ...
              if(legend_objects[objecti].legend_type == "circle"){
                ...
                svg.append("g")
                  .attr("class", "BioCircosLEGEND")
                  .selectAll("circle")
                  .data(legend_objects_circle)
                  .enter()
                  .append("circle")
                  .attr("id", "BioCircosLEGENDCircle")
        ...
        for(var cnvi=0; cnvi<self.CNV.length; cnvi++){
            ...
            if(drawTime == self.CNVsettings.compareGroup){
               if(self.CNVsettings.compareGroup == 1){
                  ...
                  var cnv_objects = BioCircosCNV2(chord.groups())
                }
            ...
            if(self.CNVsettings.CNVAnimationDisplay == true){
              svg.append("g")
                  ...
                  .transition()
                  .delay(function(d,i){
                    return i * self.CNVsettings.CNVAnimationDelay;
                  })
...
//            }else{                
                if(self.settings.CNVMouseOverDisplay==true){
                    CNVMouseOn.on("mouseover",function(d){
                          ...
                          if(self.ticksOffset != undefined){
                            CNVMouseOnTooltip.html(self.settings.CNVMouseOverTooltipsHtml01+d.cnv_chr+self.settings.CNVMouseOverTooltipsHtml02+(parseInt(d.cnv_start)+self.ticksOffset)+self.settings.CNVMouseOverTooltipsHtml03+(parseInt(d.cnv_end)+self.ticksOffset)+self.settings.CNVMouseOverTooltipsHtml04+d.cnv_val+self.settings.CNVMouseOverTooltipsHtml05)
                            .style("left", (d3.event.pageX) + "px")
                            .style("top", (d3.event.pageY + 20) + "px")
                            .style("position", self.settings.CNVMouseOverTooltipsPosition)
                            .style("background-color", self.settings.CNVMouseOverTooltipsBackgroundColor)
        ...
        for(var heatmapi=0; heatmapi<self.HEATMAP.length; heatmapi++){
            ...
            if(drawTime == self.HEATMAPsettings.compareGroup){
               if(self.HEATMAPsettings.compareGroup == 1){
                ...
                var heatmap_objects = BioCircosHEATMAP2(chord.groups())
              }
              ...
              if(self.HEATMAPsettings.HEATMAPAnimationDisplay == true){
                svg.append("g")
                    ...
                    .transition()
                    .delay(function (d,i) {
                      return i*self.HEATMAPsettings.HEATMAPAnimationDelay;
                    })
        ...
        if(self.settings.HEATMAPMouseEvent==true){
            ...
            if(self.settings.HEATMAPMouseOverDisplay==true){
                HEATMAPMouseOn.on("mouseover",function(d){
                      if(self.ticksOffset != undefined){
                        HEATMAPMouseOnTooltip.html(self.settings.HEATMAPMouseOverTooltipsHtml01+d.heatmap_chr+self.settings.HEATMAPMouseOverTooltipsHtml02+(parseInt(d.heatmap_start)+self.ticksOffset)+self.settings.HEATMAPMouseOverTooltipsHtml03+(parseInt(d.heatmap_end)+self.ticksOffset)+self.settings.HEATMAPMouseOverTooltipsHtml04+d.heatmap_name+self.settings.HEATMAPMouseOverTooltipsHtml05+d.heatmap_value+self.settings.HEATMAPMouseOverTooltipsHtml06)
                         .style("left", (d3.event.pageX) + "px")
                         .style("top", (d3.event.pageY + 20) + "px")
        ...
        for(var BUBBLEi=0; BUBBLEi<self.BUBBLE.length; BUBBLEi++){
            ...
            if(drawTime == self.BUBBLEsettings.compareGroup){
               if(self.BUBBLEsettings.compareGroup == 1){
                var BUBBLE_objects = BioCircosBUBBLE(chord.groups())
              }else{
                var BUBBLE_objects = BioCircosBUBBLE2(chord.groups())
              }
              ...
              svg.append("g")
                  .attr("class", "BioCircosBUBBLEBlock")
                  .selectAll("path.BioCircosBUBBLEBlock")
                  .data(BUBBLE_objects)
                  .enter()
                  .append("path")
                  .attr("class", "BioCircosBUBBLEBlock")
//                  .attr("fill", function(d,i) { return BUBBLEValue2Color((d.BUBBLE_value - self.BUBBLE_value_maxmin(self.BUBBLE[BUBBLEi])[1])/(self.BUBBLE_value_maxmin(self.BUBBLE[BUBBLEi])[0]-self.BUBBLE_value_maxmin(self.BUBBLE[BUBBLEi])[1])); })
  ...
  //                    console.log(self.BUBBLE_value_maxmin(self.BUBBLE[0])[1])
                    ...
                    .transition()
                    .delay(function(d,i){
                      return i * self.BUBBLEsettings.BUBBLEAnimationDelay;
                    })
  ...
  //                    console.log(self.BUBBLE_value_maxmin(self.BUBBLE[0])[1])
        ...
        if(self.settings.BUBBLEMouseEvent==true){
            var BUBBLEMouseOnTooltip = d3.select("body")
                .append("div")
                .attr("class","BioCircosBUBBLETooltip")
                .attr("id","BioCircosBUBBLETooltip")
                .style("opacity",0);

            var BUBBLEMouseOn = svg.selectAll("#BioCircosBUBBLE");

            if(self.settings.BUBBLEMouseOverDisplay==true){
                BUBBLEMouseOn.on("mouseover",function(d){
                      if(self.ticksOffset != undefined){
                        BUBBLEMouseOnTooltip.html(self.settings.BUBBLEMouseOverTooltipsHtml01+d.BUBBLE_chr+self.settings.BUBBLEMouseOverTooltipsHtml02+(parseInt(d.BUBBLE_start)+self.ticksOffset)+self.settings.BUBBLEMouseOverTooltipsHtml03+(parseInt(d.BUBBLE_end)+self.ticksOffset)+self.settings.BUBBLEMouseOverTooltipsHtml04+d.BUBBLE_name+self.settings.BUBBLEMouseOverTooltipsHtml05+d.BUBBLE_value+self.settings.BUBBLEMouseOverTooltipsHtml06)
                         .style("left", (d3.event.pageX) + "px")
                         .style("top", (d3.event.pageY + 20) + "px")
        ...
        for(var scatteri=0; scatteri<self.SCATTER.length; scatteri++){
            ...
            if(drawTime == self.SCATTERsettings.compareGroup){
               if(self.SCATTERsettings.compareGroup == 1){
                ...
                var scatter_objects = BioCircosSCATTER2(chord.groups())
              }
        ...
        if(self.settings.SCATTERMouseEvent==true){
            ...
            if(self.settings.SCATTERMouseOverDisplay==true){
                SCATTERMouseOn.on("mouseover",function(d){
                      if(self.ticksOffset != undefined){
                        SCATTERMouseOnTooltip.html(self.settings.SCATTERMouseOverTooltipsHtml01+d.scatter_chr+self.settings.SCATTERMouseOverTooltipsHtml02+(parseInt(d.scatter_start)+self.ticksOffset)+self.settings.SCATTERMouseOverTooltipsHtml03+(parseInt(d.scatter_end)+self.ticksOffset)+self.settings.SCATTERMouseOverTooltipsHtml04+d.scatter_name+self.settings.SCATTERMouseOverTooltipsHtml05+d.scatter_des+self.settings.SCATTERMouseOverTooltipsHtml06)
                         .style("left", (d3.event.pageX) + "px")
                         .style("top", (d3.event.pageY + 20) + "px")
            ...
            if(drawTime == self.SNPsettings.compareGroup){
              //console.log(chord.groups())
               if(self.SNPsettings.compareGroup == 1){
                ...
                var snp_objects = BioCircosSNP2(chord.groups())
              }
...
//                  var padding = {left:30, right:60, top:20, bottom:40};
    ...
    //                    console.log(pie(SNPCombinationData))
                ...
                if(self.settings.SNPMouseOverDisplay==true){
                  if(self.ticksOffset != undefined){
                    SNPMouseOnTooltip.html(self.settings.SNPMouseOverTooltipsHtml01+d.snp_chr+self.settings.SNPMouseOverTooltipsHtml02+(parseInt(d.snp_pos)+self.ticksOffset)+self.settings.SNPMouseOverTooltipsHtml03+d.snp_val+self.settings.SNPMouseOverTooltipsHtml04+d.snp_des+self.settings.SNPMouseOverTooltipsHtml05)
                      .style("left", (d3.event.pageX) + "px")
                      .style("top", (d3.event.pageY + 20) + "px")
            ...
            if(drawTime == self.LABELsettings.compareGroup){
              //console.log(chord.groups())
               if(self.LABELsettings.compareGroup == 1){
                var label_objects = BioCircosLABEL(chord.groups())
              }else{
                var label_objects = BioCircosLABEL2(chord.groups())
              }
...
//            lab[i].x += (Math.random() - 0.5) * max_move+Math.tan(label_objects[i].label_angle)*((Math.random() - 0.5) * max_move)
       ...
       // console.log(labelArray)
        ...
        labels=svg.append("g")
            .attr("class", "BioCircosLABEL")
          .selectAll(".label")
            .data(labelArray)
            .enter()
            .append("text")
            .attr("id", "BioCircosLABEL")
            .attr("x", (d,i) => {
                        return d.x;
                      })
            .attr("y", (d,i) => {
        ...
        for(var linki=0; linki<self.LINK.length; linki++){
            ...
            if(drawTime == self.LINKsettings.compareGroup){
               if(self.LINKsettings.compareGroup == 1){
                ...
                var link_objects = BioCircosLINK2(chord.groups())
              }
            ...
            if(self.CHORDsettings.CHORDAutoFillColor == true){
              ...
              svg.append("g")
                    ...
                    .attr("class", function (d) {if(fill(d.source.index) == self.settings.CHORDMouseFillColorExcluded && fillStroke(d.source.index) == self.settings.CHORDMouseFillColorExcluded ){
                      return "BioCircosCHORDExcluded";
                    }else
                      return "BioCircosCHORD";
                    }  )
              			.attr("d", inner_chord )
...
//                .append("div")
//                .attr("class","BioCircosCHORDTooltip")
//                .attr("id","BioCircosCHORDTooltip")
//                .style("opacity",0);


            var CHORDMouseOn = svg.selectAll("path.BioCircosCHORD");
//            console.log( document.getElementsByClassName("BioCircosCHORD"))
...
////                .style("opacity",0);
//
//            var COMPAREMouseOn = svg.selectAll("path.BioCircosCOMPARE");
//
          ...
          if(drawTime == self.LOLLIPOPsettings.compareGroup){
            //console.log(chord.groups())
             if(self.LOLLIPOPsettings.compareGroup == 1){
              var LOLLIPOP_objects = BioCircosLOLLIPOP(chord.groups())
            }else{
              var LOLLIPOP_objects = BioCircosLOLLIPOP2(chord.groups())
            }
  //                  console.log(LOLLIPOP_objects)
            ...
            if(self.LOLLIPOPsettings.PointType=="circle"){
              if(self.LOLLIPOPsettings.LOLLIPOPAnimationDisplay==false){
                ...
                //add needle-line
                svg.append("g")
                  .attr("class", "BioCircosLOLLIPOPLine")
                  .selectAll("path")
                ...
                //zhec4
                svg.append("g")
                    .attr("class", "BioCircosLOLLIPOP_homo")
                    .selectAll("circle")
                    .data(LOLLIPOP_objects_homo)
                    .enter()
                    .append("a")
                    .append("circle")
                    .attr("id", "BioCircosLOLLIPOP_homo")
                    .attr("fill", function(d,i) { 
                ...
                svg.append("g")
                    .attr("class", "BioCircosLOLLIPOP_hetero")
                    .selectAll("path")
                    .data(LOLLIPOP_objects_hetero)
                    .enter()
                    .append("a")
                    .append("path")
                    .attr("id", "BioCircosLOLLIPOP_hetero_righthalf")
                ...
                svg.selectAll(".BioCircosLOLLIPOP_hetero")
                    .selectAll("a")
                    .append("path")
                    .attr("id","BioCircosLOLLIPOP_hetero_lefthalf")
                    .data(LOLLIPOP_objects_hetero)
                    .attr("fill", function(d,i) { 
                                  if(d.LOLLIPOP_color!=undefined){
                                    return d.LOLLIPOP_color;
                ...
                svg.append("g")
                  ...
                  .transition()
                  .delay(function(d,i){
                    return i * self.LOLLIPOPsettings.LOLLIPOPAnimationDelay;
                  })
            ...
            if(self.settings.LOLLIPOPMouseClickTextFromData=="first"){
                svg.append("g")
                    .attr("class", "BioCircosLOLLIPOPlabel")
                  .selectAll("text")
                    .data(LOLLIPOP_objects)
                    .enter().append("text")
                    .attr("class", "dragText")
      ...
      if(self.settings.LOLLIPOPMouseEvent==true){
          var LOLLIPOPMouseOnTooltip = d3.select("body")
              .append("div")
              .attr("class","BioCircosLOLLIPOPTooltip")
              .attr("id","BioCircosLOLLIPOPTooltip")
              .style("opacity",0);

          var LOLLIPOPMouseOn = svg.selectAll("#BioCircosLOLLIPOP_homo,#BioCircosLOLLIPOP_hetero_lefthalf,#BioCircosLOLLIPOP,#BioCircosLOLLIPOP_hetero_righthalf");

          if(self.settings.LOLLIPOPMouseOverDisplay==true){
              LOLLIPOPMouseOn.on("mouseover",function(d){
                    if(self.ticksOffset != undefined){
                      LOLLIPOPMouseOnTooltip.html(self.settings.LOLLIPOPMouseOverTooltipsHtml01+d.LOLLIPOP_protein+self.settings.LOLLIPOPMouseOverTooltipsHtml02+d.LOLLIPOP_chr+self.settings.LOLLIPOPMouseOverTooltipsHtml03+(parseInt(d.LOLLIPOP_pos)+self.ticksOffset)+self.settings.LOLLIPOPMouseOverTooltipsHtml04+d.LOLLIPOP_strand+self.settings.LOLLIPOPMouseOverTooltipsHtml05+d.LOLLIPOP_CancerTypeNumber+self.settings.LOLLIPOPMouseOverTooltipsHtml06+d.LOLLIPOP_AA_pos+self.settings.LOLLIPOPMouseOverTooltipsHtml07+d.LOLLIPOP_AA_change+self.settings.LOLLIPOPMouseOverTooltipsHtml08+d.LOLLIPOP_Consequence+self.settings.LOLLIPOPMouseOverTooltipsHtml09)
                        .style("left", (d3.event.pageX) + "px")
                        .style("top", (d3.event.pageY + 20) + "px")
                    ...
                    d3.select(this)
                      ...
                      LOLLIPOPMouseOnTooltip.html(self.settings.LOLLIPOPMouseOverTooltipsHtml01+d.LOLLIPOP_protein+self.settings.LOLLIPOPMouseOverTooltipsHtml02+d.LOLLIPOP_chr+self.settings.LOLLIPOPMouseOverTooltipsHtml03+d.LOLLIPOP_pos+self.settings.LOLLIPOPMouseOverTooltipsHtml04+d.LOLLIPOP_strand+self.settings.LOLLIPOPMouseOverTooltipsHtml05+d.LOLLIPOP_CancerTypeNumber+self.settings.LOLLIPOPMouseOverTooltipsHtml06+d.LOLLIPOP_AA_pos+self.settings.LOLLIPOPMouseOverTooltipsHtml07+d.LOLLIPOP_AA_change+self.settings.LOLLIPOPMouseOverTooltipsHtml08+d.LOLLIPOP_Consequence+self.settings.LOLLIPOPMouseOverTooltipsHtml09)
                        .style("left", (d3.event.pageX) + "px")
                        .style("top", (d3.event.pageY + 20) + "px")
                        .style("position", self.settings.LOLLIPOPMouseOverTooltipsPosition)
                        .style("background-color", self.settings.LOLLIPOPMouseOverTooltipsBackgroundColor)
          ...
          if(self.settings.LOLLIPOPMouseClickDisplay==true && self.settings.LOLLIPOPxlink ==true){
              ...
              svg.selectAll(".BioCircosLOLLIPOP_homo")
              .selectAll("a")
              .attr("xlink:href", function(d){return d.LOLLIPOP_link});
            
              svg.selectAll(".BioCircosLOLLIPOP")
              .selectAll("a")
              .attr("xlink:href", function(d){return d.LOLLIPOP_link});
          ...
          for(var arci=0; arci<self.ARC.length; arci++){
              ...
              if(drawTime == self.ARCsettings.compareGroup){
                if(self.ARCsettings.compareGroup == 1){
                  ...
                  var arc_objects = BioCircosARC2(chord.groups())
                }
...
//                      .attr("d", function(d,i) { return arc(d,i); })
                      .transition()
                      .delay(function(d,i){
                        return i * self.ARCsettings.ARCAnimationDelay;
                      })
          ...
          if(self.settings.ARCMouseEvent==true){
              ...
              if(self.settings.ARCMouseOverDisplay==true){
                     ARCMouseOn.on("mouseover",function(d){
                        if(self.ticksOffset != undefined){
                          ARCMouseOnTooltip.html(self.settings.ARCMouseOverTooltipsHtml01+d.arc_chr+self.settings.ARCMouseOverTooltipsHtml02+(parseInt(d.arc_start)+self.ticksOffset)+self.settings.ARCMouseOverTooltipsHtml03+(parseInt(d.arc_end)+self.ticksOffset)+self.settings.ARCMouseOverTooltipsHtml04+d.arc_des+self.settings.ARCMouseOverTooltipsHtml05)
                            .style("left", (d3.event.pageX) + "px")
                            .style("top", (d3.event.pageY + 20) + "px")
